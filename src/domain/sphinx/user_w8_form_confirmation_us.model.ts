...
import GetW8FormConfirmationSchemaTemplateWithDataData from "@domain/sphinx/user_w8_form_confirmation_us.schema";
...
export const GetW8FormConfirmationSchemaTemplateWithDataDataModel = model<IGetW8FormConfirmationSchemaTemplateWithDataData>(
    ...
    GetW8FormConfirmationSchemaTemplateWithDataData
);